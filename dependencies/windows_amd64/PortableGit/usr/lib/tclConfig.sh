...
# explanation.
TCL_SHLIB_LD_LIBS='${LIBS} -Wl,--out-implib,$@.a'
...
# build directory.
TCL_BUILD_LIB_SPEC='-Wl,/usr/lib/libtcl8.6.dll.a'
...
TCL_SHARED_LIB_SUFFIX='${VERSION}.dll'
...
# compiled.
TCL_SRC_DIR='/usr/include/tcl8.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-Wl,/usr/lib/libtclstub8.6.a'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Wl,-ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/lib/libtclstub8.6.a'
